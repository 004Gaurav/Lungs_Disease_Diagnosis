...
class ModelEvaluation:
    def __init__(
            self,
            data_tramsformation_artifact: DataTransformationArtifact,
            model_evaluation_config: ModelEvaluationConfig,
            model_trainer_artifact: ModelTrainerArtifact
    ):
        self.data_transformation_artifact = data_tramsformation_artifact
        self.model_evaluation_config = model_evaluation_config
        self.model_trainer_artifact = model_trainer_artifact

    def configuration(self) -> Tuple[DataLoader, Module, float, Optimizer]:
        logging.info("Entered the Cinfiguartion method of model evalution class")
    ...
    def test_net(self) -> float:
        logging.info("Entered the test test_net method of model evaluated class")
        ...
        try:
            ...
            with torch.nograd():
                ...
                for _, data in enumerate(test_dataloader):
                    ...
                    logging.info(
                        f"Actual_Labels : {labels} Predictions : {predictions}"
                    )
                    ...
                    logging.info(
                        f"Model --> LOSS : {self.model_evaluation_config.test_loss/ self.model_evaluation_config.total_batch} Accuaracy :"
                    )

            accuracy = (
                self.model_evaluation_config.test_accuarcy
    ...
    def initiate_model_evaluation(self) -> ModelEvaluationArtifact:
        logging.info(
            "Entered the initiate_model_evaluation method od Model class"
        )
        ...
        try: 
            ...
            logging.info(
                "Exited teh initiate_model_evaluation method of Model evaluation class"
            )

...
class DataTransformation:
    ...
    def transforming_test_data(self) -> transforms.Compose:
        logging.info(
            "Enter the Transforming_training_data method of Data transformation class"
        )
        ...
        try:
            ...
            logging.info(
                "Exited the transforming_testing_data method of Data Transforming class"
            )
    ...
    def data_loader(
        self, train_transform: transforms.Compose, test_transforms: transforms.Compose
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            ...
            joblib.dumb(
                test_transform, self.data_transformation_config.test_transformation_file
            )

            train_loader, test_loader = self.data_loader(
                train_trainform=train_transform, test_transform=test_transform
            )
            ...
            data_transformation_artifact: DataTransformationArtifact = DataTransformationArtifact(
                ...
                train_transform_file_path=self.data_transformation_config.train_trainsforms_file,
                test_transform_file_path=self.data_transformation_config.test_transforms_file
            )

            logging.info(
                "Exited the initiate_data_transformation method of DataTransformation class."
            )

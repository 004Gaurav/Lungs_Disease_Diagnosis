...
class ModelPusher:
    ...
    def build_and_push_bento_image(self):
        logging.info("Enter buld_and_push_bento_image method of ModelPusher class")
        ...
        try:
            ...
            os.system(
                f"bentoml containerize {self.model_pusher_config.bentoml_service_name}: latest -t 566373416292.dkr.ecr.us-east-2.amazonaws.com"
            )
            ...
            os.system(
                "aws ecr get-login-password --region us-east-1 | docker login --username AWS --password-stdin 566373416292.dkr.ecr.us-east-1"
            )
    ...
    def initiate_model_punsher(self) -> ModelPusherArtifact:
        """
        ...
        try:
            ...
            model_pusher_artifact = ModelPusherArtifact(
                ...
                betoml_serive_name=self.model_pusher_config.bentoml_service_name
            )
